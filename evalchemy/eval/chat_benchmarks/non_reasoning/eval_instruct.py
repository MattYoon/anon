...
**Answer**: $ANSWER
**Confidence**: $CLASS
The answer should be concise. If the question was multiple choice, just output the correct option. If you didn't find an answer yet, give me your best guess. You must give an answer and its confidence.'''
