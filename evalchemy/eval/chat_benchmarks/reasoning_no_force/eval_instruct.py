...
SYSTEM_PROMPT = "Make sure to include both of the thinking process for the question and the confidence assessment in the <think> tags."
...
class Benchmark(BaseBenchmark):
    ...
    def generate_responses(self, model: LM) -> Dict[str, Any]:
        ...
        for idx, example in enumerate(examples):
            ...
            if 'qwq' in model_name.lower() or 'skyworks' in model_name.lower():
                # Add system prompt for QWQ
                messages.insert(
        ...
        for example, output, output_answer in zip(examples, outputs, outputs_answer):
            ...
            # outputs_answer = output_answer.split("</think>")
